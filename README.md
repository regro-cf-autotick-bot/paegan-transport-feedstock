About paegan-transport-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/paegan-transport-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3186&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/paegan-transport-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `paegan-transport` can be installed with `conda`:
...
```
mamba install paegan-transport
```

It is possible to list all of the versions of `paegan-transport` available on your platform with `conda`:
...
```
mamba search paegan-transport --channel conda-forge
```
...
mamba repoquery search paegan-transport --channel conda-forge

# List packages depending on `paegan-transport`:
mamba repoquery whoneeds paegan-transport --channel conda-forge

# List dependencies of `paegan-transport`:
mamba repoquery depends paegan-transport --channel conda-forge
```
